...
4. If any library is not installed in the env, please make sure to do the same by providing the shell script and use pip to install(like pip install matplotlib pandas) and after that send the code again without changes , install the required libraries.
example
```sh
